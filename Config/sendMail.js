        ...
        const emailContent = {
            ...
            <div style="max-width:600px; margin:0 auto; font-family:'Segoe UI', sans-serif; color:#333; background:#ffffff; border:1px solid #e0e0e0; border-radius:8px; overflow:hidden;">
              ...
              <div style="background-color:#fff; padding:20px; text-align:center;">
                <img src="https://i.pinimg.com/736x/4f/9e/17/4f9e17fb9da6c9188371e6fc97416c67.jpg" alt="MOVIE Logo" style="width:120px; height:auto; margin-bottom:10px; class='custom'" />
                <h1 style="color:#000; font-size:22px; margin:0;">Connexion à votre compte.</h1>
              </div>
