...
const Detail = () => {
  ...
  const handleSubmitComment = async () => {
    ...
    try {
      ...
      setVisible(false); // Correction : utilisez setVisible au lieu de visible
    } catch (error) {
    ...
    <div className="container-detail" style={{ minHeight: '50vh' }}>
        ...
        >
          ...
          <p className={`lead mb-3 mb-lg-4 ${isMobile ? 'fs-6' : ''}`}>
            ...
            <p className='fs-6 text-dark fs-lg-5'>
              {format(new Date(movie.release_date), "d MMMM yyyy 'à' HH:mm", { locale: fr })}</p>
          </p>
      ...
      <div className="detail-bottom p-3 p-lg-4">
        ...
        <div className="db-bottom">
          ...
          {visible && (
            <div style={{}} className="comment-form z-2 top-0 bottom-0 start-0 end-0 position-absolute bg-black bg-opacity-75 p-4 d-flex justify-content-center align-items-center rounded-3">
              ...
              <div className="bg-white bg-opacity-25 rounded-3 px-4 py-3">
                <div className='d-flex align-items-center gap-3'>
                          ...
                          >
                            <span className='fs-4 text-white fw-bold'>A
                            </span>
                          </div>
                          <div className="user-info">
                            <h5 className="mb-0 text-white fw-bold">
                               {storedUser ? 
                                 decodeURIComponent(escape(JSON.parse(atob(storedUser.split('.')[1])).first_name))
                                 : 'Utilisateur'
                               }
                             </h5>
                            <p className="mb-0 text-white-50 small">
                  ...
                  <form className="comment-body m-3 gap-3 d-flex flex-column" onSubmit={handleSubmitComment}>
                      <textarea 
