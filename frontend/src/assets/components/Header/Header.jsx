...
const Header = () => {
    ...
    const size = 20
  return (
    <header className="d-flex justify-content-between flex-column align-items-center py-3 px-5 text-light">
      <div className="desktop d-none d-md-flex justify-content-between w-100">
          <div className="h-left d-flex align-items-center">
            ...
            <nav>
              <ul className="nav">
                <li className="nav-item"><Link className="nav-link text-light" to="/films">Tous les films</Link></li>
